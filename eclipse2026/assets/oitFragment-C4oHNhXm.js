...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var ee={name:t,shader:n},r=`prePassDeclaration`,i=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a={name:r,shader:i},o=`oitDeclaration`,s=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=s);var te={name:o,shader:s},c=`lightFragmentDeclaration`,l=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=l);var ne={name:c,shader:l},u=`lightUboDeclaration`,d=`#ifdef LIGHT{X}
uniform Light{X}
...
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _={name:h,shader:g},v=`shadowsFragmentFunctions`,y=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);var b={name:v,shader:y},x=`samplerFragmentDeclaration`,S=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var ie={name:x,shader:S},C=`reflectionFunction`,w=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var T={name:C,shader:w},E=`imageProcessingDeclaration`,D=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=D);var O={name:E,shader:D},k=`imageProcessingFunctions`,A=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var j={name:k,shader:A},M=`textureRepetitionFunctions`,N=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=N);var ae={name:M,shader:N},P=`bumpFragmentMainFunctions`,F=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=F);var oe={name:P,shader:F},I=`bumpFragmentFunctions`,L=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=L);var R={name:I,shader:L},z=`bumpFragment`,B=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=B);var V={name:z,shader:B},H=`decalFragment`,U=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=K);var se={name:G,shader:K},q=`lightFragment`,J=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=J);var ce={name:q,shader:J},Y=`logDepthFragment`,X=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=X);var le={name:Y,shader:X},Z=`oitFragment`,Q=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
