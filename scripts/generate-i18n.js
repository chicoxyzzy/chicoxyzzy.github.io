...
const locales = [
  {
    ...
    htmlLang: "es",
    ogLocale: "es_ES",
    imageAlt: "Tarjeta de vista previa del sitio de Sergey Rubanov: desarrollo, estándares web y agentes de IA",
    description:
      "Desarrollo, investigación independiente y open source en infraestructura para agentes de IA, plataforma web y herramientas para desarrolladores.",
    messages: {
      ...common,
      ...
      "hero.tagline": "Investigación · estándares web · agentes de IA · open source",
      "hero.summary":
        "Desarrollo, investigación independiente y open source en infraestructura para agentes de IA, plataforma web y herramientas para desarrolladores.",
      "hero.standards":
        'Trabajo con estándares de <span class="tc39">TC39</span> y <span class="w3c">W3C</span>, donde las especificaciones se encuentran con el comportamiento de navegadores, runtimes y APIs para desarrolladores.',
      "skills.heading": "Competencias clave",
      "skills.ai": "Sistemas AI / LLM",
      "skills.agentOrchestration": "orquestación de agentes",
      "skills.promptTool": "flujos prompt/herramienta",
      ...
      "project.hecate.features": "Sesiones supervisadas con agentes de código · aprobaciones de tareas · visibilidad de uso · OpenTelemetry",
      "project.cynic.what": "Motor ECMAScript strict-only en Zig para hosts no navegador como edge JS, Workers y JS de servidor",
      ...
      "project.more.key": "dónde",
      "project.more.what": "Más trabajo open source, experimentos y herramientas pequeñas viven en GitHub.",
      "contact.openTo": "abierto a: agentes de IA · plataforma web · herramientas para desarrolladores · observabilidad · estándares",
      "contact.location": "basado en Barcelona, España · disponible en remoto",
  ...
  },
  {
    ...
    htmlLang: "ca",
    ogLocale: "ca_ES",
    imageAlt: "Targeta de previsualització del lloc de Sergey Rubanov: desenvolupament, estàndards web i agents d'IA",
    description:
      "Desenvolupament, recerca independent i codi obert en infraestructura per a agents d’IA, plataforma web i eines per a desenvolupadors.",
    messages: {
      ...common,
      ...
      "hero.summary":
        "Desenvolupament, recerca independent i codi obert en infraestructura per a agents d'IA, plataforma web i eines per a desenvolupadors.",
      "hero.standards":
        'Treball amb estàndards de <span class="tc39">TC39</span> i <span class="w3c">W3C</span>, allà on les especificacions es troben amb el comportament dels navegadors, els runtimes i les APIs per a desenvolupadors.',
      "skills.heading": "Competències clau",
      "skills.ai": "Sistemes AI / LLM",
      "skills.agentOrchestration": "orquestració d'agents",
      "skills.promptTool": "fluxos prompt/eina",
      ...
      "project.hecate.features": "Sessions supervisades amb agents de codi · aprovacions de tasques · visibilitat d'ús · OpenTelemetry",
      "project.cynic.what": "Motor ECMAScript strict-only en Zig per a hosts no navegador com edge JS, Workers i JS de servidor",
      ...
      "project.more.key": "on",
      "project.more.what": "Més feina de codi obert, experiments i eines petites viuen a GitHub.",
      "contact.openTo": "obert a: agents d'IA · plataforma web · eines per a desenvolupadors · observabilitat · estàndards",
      "contact.location": "basat a Barcelona, Espanya · disponible en remot",
      ...
      "retro.modalStep": "Engegant emmagatzematge noranter",
  ...
  },
  {
    ...
    htmlLang: "zh-Hans",
    ogLocale: "zh_CN",
    imageAlt: "Sergey Rubanov 网站的社交预览卡片：开发、Web 平台标准和 AI agents",
    description: "围绕 AI agent 基础设施、Web 平台、开发者工具和开源工作的开发与独立研究。",
    messages: {
      ...common,
      "skip.main": "跳到主要内容",
      "nav.primary": "主要链接",
      ...
      "hero.name": "Sergey Rubanov",
      "hero.nameCaps": "SERGEY RUBANOV",
      "hero.tagline": "研究 · Web 平台标准 · AI agents · 开源",
      "hero.summary": "围绕 AI agent 基础设施、Web 平台、开发者工具和开源工作的开发与独立研究。",
      "hero.standards": '参与 <span class="tc39">TC39</span> 与 <span class="w3c">W3C</span> 标准相关工作，关注规范文本、浏览器行为、运行时实现和开发者 API 之间的边界。',
      "skills.heading": "核心技能",
      "skills.ai": "AI / LLM 系统",
      "skills.agentOrchestration": "agent 协调",
      "skills.promptTool": "prompt/工具流程",
      "skills.harness": "测试框架",
      ...
      "project.hecate.features": "受监督的代码代理会话 · 任务审批 · 使用情况可见性 · OpenTelemetry",
      ...
      "project.tc39mcp.what": "MCP 服务器，将 TC39 规范暴露为按条款组织、由 SHA 固定的数据，供 agents 和开发工具使用",
      ...
      "contact.openTo": "关注方向：AI agents · Web 平台 · 开发者工具 · 可观测性 · 标准",
      ...
      "retro.aboutCopy": '嗨!!! 我叫 Sergey，是一名 <b style="color:#00ffff">软件工程师!!!</b> 我做 <b style="color:#ffff00">AI agents</b>、<b style="color:#00ff00">Web 平台</b> 和开发者工具!!! 也参与 <span class="blink" style="color:#ff00ff"><b>TC39 + W3C</b></span> 的标准工作，替你阅读那些规范文本!!!',
  ...
  },
  {
    ...
    imageAlt: "Карточка предпросмотра сайта Сергея Рубанова: разработка, стандарты веб-платформы и AI-агенты",
    description:
      "Разработка, независимые исследования и open source на стыке AI-агентов, веб-платформы и инструментов для разработчиков.",
    messages: {
      ...common,
      ...
      "hero.tagline": "Исследования · стандарты веб-платформы · AI-агенты · open source",
      "hero.summary": "Разработка, независимые исследования и open source на стыке AI-агентов, веб-платформы и инструментов для разработчиков.",
      "hero.standards": 'Работа со стандартами <span class="tc39">TC39</span> и <span class="w3c">W3C</span>: там, где тексты спецификаций встречаются с поведением браузеров, рантаймов и API для разработчиков.',
      "skills.heading": "Ключевые навыки",
      "skills.ai": "AI / LLM системы",
      "skills.agentOrchestration": "оркестрация агентов",
      "skills.promptTool": "prompt/tool-потоки",
      ...
      "project.what": "что",
      "project.features": "функции",
      "project.stack": "стек",
      "project.soon": "скоро",
      "project.pragmatist.soonLabel": "Pragmatist скоро выйдет",
      "project.hecate.what": "Local-first консоль для локальных и облачных AI-моделей, включая Hecate Chat",
      "project.hecate.features": "Супервизируемые сессии с агентами для кода · подтверждения задач · видимость использования · OpenTelemetry",
      "project.cynic.what": "Strict-only ECMAScript-движок на Zig для небраузерных окружений: edge JS, Workers и server-side JS",
      ...
      "project.pragmatist.features": "Запросы к спецификациям · механизация в Coq/Rocq · сравнение парсера и библиотек TypeScript · дифференциальные прогоны движков · заготовки патчей для test262/spec · детерминированная проверка",
      "project.tc39mcp.what": "MCP-сервер, который отдаёт спецификации TC39 как данные по разделам, зафиксированные SHA, для агентов и инструментов",
      "project.tc39mcp.features": "Поиск по AOID · ссылки между спецификациями · диффы редакций · история git · поиск по test262 и proposals · офлайн stdio и публичный HTTP",
      "project.more.title": "Другие проекты",
      "project.more.personal": "личные репозитории",
      "project.more.key": "где",
      "project.more.what": "Больше open-source работы, экспериментов и небольших инструментов — на GitHub.",
      "contact.openTo": "интересы: AI-агенты · веб-платформа · инструменты для разработчиков · наблюдаемость · стандарты",
      "contact.location": "Барселона, Испания · открыт к удалённой работе",
      ...
      "tweaks.close": "Закрыть визуальные настройки и доступность",
      ...
      "retro.aboutCopy": 'ПРИВЕТ!!! Меня зовут Сергей, и я <b style="color:#00ffff">РАЗРАБОТЧИК!!!</b> Я работаю над <b style="color:#ffff00">AI-агентами</b>, <b style="color:#00ff00">веб-платформой</b> и инструментами для разработчиков!!! Ещё я участвую в работе над стандартами <span class="blink" style="color:#ff00ff"><b>TC39 + W3C</b></span> и читаю спецификации, чтобы тебе не пришлось!!!',
      ...
      "retro.projectsCopy": '<b style="color:#ffff00">Hecate</b> — local-first консоль для локальных и облачных AI-моделей, Hecate Chat, супервизируемых сессий с агентами для кода, подтверждений задач, видимости использования и OpenTelemetry!!!<br>🌐 <a href="https://hecate.sh" target="_blank" rel="noopener noreferrer" class="retro-link">hecate.sh</a> · 💾 <a href="https://github.com/hecatehq/hecate" target="_blank" rel="noopener noreferrer" class="retro-link">исходный код</a><br><br><b style="color:#ffff00">Cynic</b> — strict-only ECMAScript-движок на Zig для небраузерных окружений!!!<br>🌐 <a href="https://sergey.works/cynic" target="_blank" rel="noopener noreferrer" class="retro-link">sergey.works/cynic</a> · 💾 <a href="https://github.com/chicoxyzzy/cynic" target="_blank" rel="noopener noreferrer" class="retro-link">исходный код</a><br><br><b style="color:#ffff00">Pragmatist</b> — инструмент для поиска, воспроизведения и проверки ошибок в ECMA-262, TypeScript и JS-движках!!! Он спрашивает спецификации, сравнивает движки, готовит патчи для test262/spec и не верит на слово!!!<br><span class="retro-soon">Скоро релиз!!!</span><br><br><b style="color:#ffff00">tc39-mcp</b> — MCP-сервер для спецификаций TC39!!! Агенты получают SHA-pinned разделы ECMA-262 + ECMA-402, AOID-поиск, ссылки, диффы, историю, test262 и proposals вместо парсинга огромного HTML-файла!!!<br>🌐 <a href="https://tc39-mcp.chicoxyzzy.workers.dev" target="_blank" rel="noopener noreferrer" class="retro-link">tc39-mcp docs</a> · 💾 <a href="https://github.com/xyzzylabs/tc39-mcp" target="_blank" rel="noopener noreferrer" class="retro-link">исходный код</a>',
      "retro.guestbookTitle": "📖 ПОДПИШИ МОЮ ГОСТЕВУЮ КНИГУ!!! 📖",
      "retro.guestbookHandle": "ТВОЁ ИМЯ:",
      "retro.guestbookMessage": "СООБЩЕНИЕ ДЛЯ СЕРГЕЯ:",
      "retro.guestbookSubmit": "Подписать гостевую",
      ...
      "retro.modalTitle": "Настройка гостевой книги",
      "retro.modalSaving": "Сохраняю подпись в гостевой книге...",
