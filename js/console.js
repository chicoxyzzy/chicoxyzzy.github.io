...
function initConsole(){
  ...
  const FILES = {
    ...
    '~/projects/hecate.txt': { type:'file', mode:'-rw-r--r--', size:'920', date:'May 20', content:[
      'Hecate',
      'What:',
      'Local-first AI workspace and runtime for chats, model providers,',
      'project-scoped work, and supervised coding agents.',
      '',
      'Features:',
      '- OpenAI and Anthropic API compatibility',
      '- native and ACP agent sessions',
      '- approvals and diff review',
      '- project context and memory',
      '- usage reporting and OpenTelemetry',
      '',
      'site: https://hecate.sh',
      'code: https://github.com/hecatehq/hecate'
    ]},
    '~/projects/cynic.txt': { type:'file', mode:'-rw-r--r--', size:'760', date:'May 20', content:[
      'Cynic',
      'What:',
      'Strict-only ECMAScript and WebAssembly engine written from scratch in Zig,',
      'with hardened realms and host-controlled code generation.',
      '',
      'Features:',
      '- strict semantics without Annex B',
      '- frozen primordials and built-in harden()',
      '- opt-in eval and host-controlled Wasm compilation',
      '- Test262 and Wasm conformance suites',
      '',
      'site: https://sergey.works/cynic',
      'code: https://github.com/chicoxyzzy/cynic'
    ]},
    '~/projects/pragmatist.txt': { type:'file', mode:'-rw-r--r--', size:'1.1K', date:'May 28', content:[
      'Pragmatist',
      'What:',
      'Tool that lets agents find and prove bugs in ECMAScript specifications,',
      'TypeScript, JavaScript engines, and WebAssembly runtimes.',
      '',
      'Features:',
      '- specification data pinned to upstream commits',
      '- Coq/Rocq mechanization',
      '- TypeScript AST and library diffs',
      '- cross-runtime differential runs',
      '- patch scaffolding',
      '- deterministic replay of every finding',
      '',
      'release: coming soon'
    ]},
    '~/projects/tc39-mcp.txt': { type:'file', mode:'-rw-r--r--', size:'960', date:'Jun 02', content:[
      'TC39 MCP',
      'What:',
      'MCP server that gives agents structured, reproducible access to ECMA-262',
      'and ECMA-402 instead of a multi-megabyte HTML document.',
      '',
      'Features:',
      '- clause and AOID search',
      '- bidirectional cross-spec references',
      '- edition diffs and git history',
      '- Test262 and proposal lookup',
      '- SHA-pinned responses',
      '- local stdio and hosted HTTP',
      '',
      'site: https://mcp.xyzzylabs.ai/tc39/',
      'code: https://github.com/xyzzylabs/tc39-mcp'
    ]},
    '~/projects/wasm-mcp.txt': { type:'file', mode:'-rw-r--r--', size:'900', date:'Jun 26', content:[
      'WASM MCP',
      'What:',
      'Read-only MCP server for the WebAssembly Core, JavaScript, and Web APIs,',
      'with instruction-level and clause-level lookup.',
      '',
      'Features:',
      '- opcode, stack signature, and trap metadata',
      '- validation and execution references',
      '- full-text spec search and proposal index',
      '- SHA-pinned deterministic responses',
      '- local stdio and hosted HTTP',
      '',
